 ...
 * D/C        |PC8 PC3      |Data/Command buffer access select
 * RESET	  |PC7 PB14		|Reset (held high, go low to reset)
...
#define SSD1306_CMD_ACCESS() HAL_GPIO_WritePin(GPIOC, GPIO_PIN_3, GPIO_PIN_RESET)
#define SSD1306_DISP_ACCESS() HAL_GPIO_WritePin(GPIOC, GPIO_PIN_3, GPIO_PIN_SET)

/* Reset pin control */
#define SSD1306_RESET_HIGH() HAL_GPIO_WritePin(GPIOB, GPIO_PIN_14, GPIO_PIN_SET)
#define SSD1306_RESET_LOW() HAL_GPIO_WritePin(GPIOB, GPIO_PIN_14, GPIO_PIN_RESET)
